...
function dbroutes(router, platform) {
    ...
    router.get("/txList/:channel_genesis_hash/:blocknum/:txid", (req, res) => __awaiter(this, void 0, void 0, function* () {
        ...
        if (channel_genesis_hash) {
            const extReq = req;
            dbCrudService
                .getTxList(extReq.network, channel_genesis_hash, blockNum, txid, from, to, orgs, isFromSet)
    ...
    router.get("/blockAndTxList/:channel_genesis_hash/:blocknum", (req, res) => __awaiter(this, void 0, void 0, function* () {
        ...
        if (channel_genesis_hash && !isNaN(blockNum)) {
            ...
            return dbCrudService
                .getBlockAndTxList(extReq.network, channel_genesis_hash, blockNum, from, to, orgs, isFromSet)
                .then(handleResult(req, res));
        }
        return requtil.invalidRequest(req, res);
    }));
    ...
    router.get("/tokenhistoryforowner/:integraid", (req, res) => __awaiter(this, void 0, void 0, function* () {
        http_1.default.get(`${env_config_1.config.sdk_url}/tokenhistoryforowner/${req.params.integraid}`, resP => {
    ...
    router.get("/holders", (req, res) => __awaiter(this, void 0, void 0, function* () {
        // Do stuff with response
        http_1.default.get(`${env_config_1.config.sdk_url}/holders?limit=${req.query.limit}`, resP => {
            resP.setEncoding("utf8");
            let body = "";
            resP.on("data", data => {
                body += data;
